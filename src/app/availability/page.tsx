    ...
    <div className="min-h-screen bg-[#f7f3f6] text-neutral-900">
      ...
      <main className="relative mx-auto w-full max-w-6xl px-4 pb-20 pt-10 sm:px-6">
        ...
        <section className="rounded-3xl border border-[#4d082a]/10 bg-white/80 p-6 shadow-[0_20px_60px_rgba(77,8,42,0.12)] backdrop-blur sm:p-10">
          <h1
            className="mt-4 text-3xl font-semibold text-[#2d0a1a] sm:text-4xl md:text-5xl"
        ...
        <section className="mt-10">
          <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-[0_12px_40px_rgba(15,23,42,0.12)] sm:p-6">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <h2 className="text-2xl font-semibold text-[#4d082a]">Book a Time</h2>
              <span className="rounded-full border border-[#4d082a]/20 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-neutral-500">
                Scheduler
              </span>
            </div>
            <div className="mt-4 overflow-hidden rounded-xl border border-neutral-200 bg-neutral-50">
              {calendlyEmbedUrl ? (
                ...
                <div className="flex h-[420px] flex-col items-center justify-center gap-4 px-6 text-center">
                  <p className="text-base font-semibold text-neutral-700">Scheduling coming soon!</p>
